...
namespace carve {
	namespace csg {
		...
		public:
			...
			void findPerimeter(const std::vector<triangulate::tri_idx> &tris, const std::vector<carve::mesh::MeshSet<3>::vertex_t *> &verts, std::vector<carve::mesh::MeshSet<3>::vertex_t *> &out)
			{
