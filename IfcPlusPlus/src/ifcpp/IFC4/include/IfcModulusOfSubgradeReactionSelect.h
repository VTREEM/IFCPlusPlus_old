...
class IfcModulusOfSubgradeReactionSelect : public IfcPPAbstractSelect
{
public:
	...
	static shared_ptr<IfcModulusOfSubgradeReactionSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
