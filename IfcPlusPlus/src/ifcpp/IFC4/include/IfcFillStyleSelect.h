...
class IfcFillStyleSelect : public IfcPPAbstractSelect
{
public:
	IfcFillStyleSelect();
	~IfcFillStyleSelect();
	...
	static shared_ptr<IfcFillStyleSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
