...
class IfcObjectReferenceSelect : public IfcPPAbstractSelect
{
public:
	...
	static shared_ptr<IfcObjectReferenceSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
