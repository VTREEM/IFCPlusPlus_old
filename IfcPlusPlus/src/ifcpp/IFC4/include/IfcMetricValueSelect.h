...
class IfcMetricValueSelect : public IfcPPAbstractSelect
{
public:
	...
	static shared_ptr<IfcMetricValueSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcPPEntity> >& map );
};
