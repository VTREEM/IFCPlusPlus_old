...
#include "ifcpp/IFC2X4/include/IfcParameterizedProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcArbitraryOpenProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcArbitraryClosedProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcCompositeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcDerivedProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcCurve.h"
#include "ifcpp/IFC2X4/include/IfcArbitraryProfileDefWithVoids.h"
#include "ifcpp/IFC2X4/include/IfcBoundedCurve.h"
#include "ifcpp/IFC2X4/include/IfcCartesianTransformationOperator2D.h"
#include "ifcpp/IFC2X4/include/IfcRectangleProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcCircleProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcCircleHollowProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcTrapeziumProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcCenterLineProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcPositiveLengthMeasure.h"
#include "ifcpp/IFC2X4/include/IfcRectangleHollowProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcRoundedRectangleProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcPositiveLengthMeasure.h"
#include "ifcpp/IFC2X4/include/IfcLengthMeasure.h"
#include "ifcpp/IFC2X4/include/IfcNonNegativeLengthMeasure.h"
#include "ifcpp/IFC2X4/include/IfcEllipseProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcIShapeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcAsymmetricIShapeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcLShapeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcUShapeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcCShapeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcZShapeProfileDef.h"
#include "ifcpp/IFC2X4/include/IfcPlaneAngleMeasure.h"
#include "ifcpp/IFC2X4/include/IfcTShapeProfileDef.h"
...
void ProfileConverter::addArc( std::vector<carve::geom::vector<3> >& coords, double radius, double start_angle, double opening_angle, double xM, double yM, int segments )
{
	double angle = start_angle;
	double angle_delta = opening_angle / (double)segments;
	for( int i=0; i<segments; ++i )
	{	
...
void ProfileConverter::addFullArc( std::vector<carve::geom::vector<3> >& coords, double radius, double start_angle, double opening_angle, double xM, double yM, int segments )
{
	double angle = start_angle;
	double angle_delta = opening_angle / (double)(segments-1);
	for( int i=0; i<segments; ++i )
	{	
		coords.push_back( carve::geom::VECTOR( radius * cos(angle) + xM,  radius * sin(angle) + yM, 0 ) );
		angle += angle_delta;
...
void ProfileConverter::addAndOptimize( const std::vector<carve::geom::vector<3> >& polygon, std::vector<std::vector<carve::geom::vector<3> > >& paths ) const
{
	if( polygon.size() < 1 )
	{
		return;
...
void ProfileConverter::convertIfcParameterizedProfileDef( const shared_ptr<IfcParameterizedProfileDef>& profile, std::vector<std::vector<carve::geom::vector<3> > >& paths ) const
{
	...
	{
		//Parameter:
		double h = t_shape->m_Depth->m_value*length_factor;
		double b = t_shape->m_FlangeWidth->m_value*length_factor;
		double tw = t_shape->m_WebThickness->m_value*length_factor*0.5;
		double tf = t_shape->m_FlangeThickness->m_value*length_factor;
